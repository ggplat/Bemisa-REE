...
_RULES = [
    ...
    (r"\bquarter|trimestr", "Trimestral"),
    (r"half[- ]year|interim|semestr", "Semestral"),
    (r"annual report|relat(o|ó)rio anual", "Relatório Anual"),
    (r"\bpresent|apresenta(c|ç)", "Apresentação"),
    (r"drill|sondagem|assay|intercept|mineraliz", "Exploração"),
    (r"placement|capital rais|entitlement|capta(c|ç)", "Captação"),
    (r"trading halt|\bhalt", "Trading Halt"),
