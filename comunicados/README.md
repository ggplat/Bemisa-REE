...
```
ree_monitor.py        -> coleta comunicados + calcula a % + gera docs/comunicados/index.html
...
docs/comunicados/index.html       -> SAÍDA gerada (publicada pelo GitHub Pages)
...
Abra `docs/comunicados/index.html` no navegador.
...
2. Executa `python ree_monitor.py --dashboard`, commita o `docs/comunicados/index.html`
